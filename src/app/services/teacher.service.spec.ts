...
/** Android parity for the web direct-to-object-storage upload flow — see the web repo's
 * teacher.service.spec.ts for the exhaustive version of this same shared contract. */
