...
describe('G1 timetable screen', () => {
  let c: TimetableComponent;
  let api: any;
  let toast: any;
  beforeEach(() => {
    api = jasmine.createSpyObj('TimetableService', ['createEntry', 'updateEntry', 'deleteEntry', 'addSimultaneous', 'getClassTimetable', 'getTeacherTimetable']);
